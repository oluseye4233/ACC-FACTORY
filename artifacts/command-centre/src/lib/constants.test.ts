...
describe("F_PROCESS_ROLES", () => {
  it("should have exactly 12 roles", () => {
    expect(F_PROCESS_ROLES.length).toBe(12);
  });

  it("should be ordered correctly from F0 to F10", () => {
    const expectedIds = [
      "F0", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F9.5", "F10"
    ];
  ...
  it("should have correct statuses for operational vs contract", () => {
    const operational = ["F0", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F9.5", "F10"];
