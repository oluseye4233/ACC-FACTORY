...
- [Exemplar download filenames](exemplar-download-filenames.md) — downloads use artifact type, readable title, stable library ID, local timestamp, and actual text/JSON extension.
