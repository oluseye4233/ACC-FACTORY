...
- [Provider pricing source monitoring](provider-pricing-source-monitoring.md) — fingerprints are review-only; a separate monitor must detect when the weekly pricing workflow stops succeeding.
